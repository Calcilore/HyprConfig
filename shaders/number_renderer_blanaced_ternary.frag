...
// int balancedTernaryDigit(int number, int digit) {
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    int digits = max(1, int(ceil(logx(base, 2.0 * float(number) + 1.0))));
